...
const Project = () => {
  ...
  return (
    <div className={classes.projectContainer} id="portfolioId">
      ...
      {/* Experience Chart skills set */}

      <div className={classes.skillHeading} data-aos="flip-up">
        <h1>Relevant Skillset</h1>
      </div>

      <div className={classes.skills} data-aos="slide-right">
        <div className={classes.skillset}>
          <AnimatedProgressProvider className={classes.animatedprogress}
            valueStart={0}
            valueEnd={70}
            duration={1.4}
          ...
          >
            {value => {
              ...
              return (
                <CircularProgressbar className={classes.percentageSkills}
                  value={value}
                  text={`${roundedValue}%`}
                  styles={buildStyles({
                    pathTransition: "none"
            ...
            {value => {
              ...
              return (
                <CircularProgressbar className={classes.percentageSkills}
                  ...
                  styles={buildStyles({
                    pathTransition: "none",
                    pathColor: `rgba(240, 219, 79, ${value / 100})`
                  })}
                />
              );
            }}
            ...
            {value => {
              ...
              return (
                <CircularProgressbar className={classes.percentageSkills}
                  ...
                  styles={buildStyles({
                    pathTransition: "none",
                    pathColor: `rgba(86, 61, 124, ${value / 100})`
                  })}
                />
              );
            }}
            ...
            {value => {
              ...
              return (
                <CircularProgressbar className={classes.percentageSkills}
                  ...
                  styles={buildStyles({
                    pathTransition: "none",
                    pathColor: `rgba(243, 79, 41, ${value / 100})`
                  })}
                />
              );
            }}
            ...
            {value => {
              ...
              return (
                <CircularProgressbar className={classes.percentageSkills}
                  ...
                  styles={buildStyles({
                    pathTransition: "none",
                    pathColor: `rgba(63, 160, 55, ${value / 100})`
                  })}
                />
              );
            }}
            ...
            {value => {
              ...
              return (
                <CircularProgressbar className={classes.percentageSkills}
                  ...
                  styles={buildStyles({
                    pathTransition: "none",
                    pathColor: `rgba(48, 105, 152, ${value / 100})`
                  })}
                />
              );
            }}
